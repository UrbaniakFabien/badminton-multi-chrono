...
<![endif]-->
<meta charset="utf-8">
<title>Import Liste joueurs</title>
  ...
  $("#frm_param_integre").dialog({ title:'Configuration import',
                                      ...
                                      buttons: [{
                                          ...
                                          'click': function() {  $( this ).dialog( "close" );    
                                                               $("#msg").html("Import des joueurs depuis les fichiers téléchargés en cours ! <img src='images/wait.gif' style='width:30px;height:30px;'>");
                                                               var param=$('input[name=prm_import]:checked').val()
                                                                $.post('jquery/jQuery-File-Upload/integre_joueurs.7.php',
                                                                        {prm_import : param},
                                                                        function(data) {
...
<div class="container">
    <div class="page-header">
        <h1>T&eacute;l&eacute;chargement liste(s) joueur(s)</h1>
    </div>
    <br />
    <span id="msg"></span>
    <br />
...
<!--Formulaire pour parametrage integration des liste avec ou sans réinitialisation -->
<form id="frm_param_integre">
    <h2>Si cette ou ces listes ont d&eacute;j&agrave; &eacute;t&eacute; integr&eacute;es </h2><br>
   
        <input type="radio"  name="prm_import"  checked="checked" value="0"/>&nbsp;R&eacute;initialiser tout<br>
       
    
       <input type="radio" name="prm_import" value="1"/>&nbsp;Conserver l'&eacute;tat des joueurs<br>
