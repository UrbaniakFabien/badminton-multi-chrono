...
function Import() {
  //fonction d'import des fichiers uploadés
    $("#msg").html("Import &eacute;ch&eacute;ancier(s) depuis les fichiers téléchargés en cours ! <img src='images/wait.gif' style='width:30px;height:30px;'>");
    var rep="n";
...
<div class="container">
    <div class="page-header">
        <h1>T&eacute;l&eacute;chargement échéancier(s)</h1>
    </div>
    <br />
    <span id="msg"></span>
    <br />
